...
mod tests {
    ...
    fn should_not_be_possible() {
        let ticket = Ticket::new("A title".into(), "A description".into(), "To-Do".into()); //had to modify func to be pub
        ...
        assert_eq!(ticket.description, "A description"); //had to modify field to be pub
    }
    ...
    fn encapsulation_cannot_be_violated() {
        ...
        let ticket = Ticket {
            title: "A title".into(), //had to modify field to be pub
            description: "A description".into(),
            status: "To-Do".into(), //had to modify field to be pub
        };
    }
}
