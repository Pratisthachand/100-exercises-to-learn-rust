...
fn speed(start: u32, end: u32, time_elapsed: u32) -> u32 {
    ...
    //In Rust, a Panic is different from a Result.
    // Result: "Something went wrong, please handle it."
    // Panic: "Something went horribly wrong, stop the entire program immediately!"
    // If you actually want to panic, you use the panic! macro.
